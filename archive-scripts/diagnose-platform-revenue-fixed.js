...
if (fs.existsSync(serverPath)) {
  ...
  hasRegistration = serverContent.includes('platform-revenue') || 
...
async function runDiagnosis() {
  ...
  const result = await testEndpoint('/api/platform-revenue');
  ...
  console.log('Route File: ' + (foundRoute ? 'EXISTS (' + foundRoute + ')' : 'MISSING'));
