...
// GET /api/users/:id - 獲取特定用戶資訊（所有人可見）
...
// GET /api/users/department/:departmentId - 獲取部門用戶（所有人可見）
...
router.post('/:id/avatar', auth_1.authenticateToken, (0, auth_1.requireSelfOrAdmin)('id'), async (req, res) => {
 ...
 // 記錄日誌
 await (0, logger_1.logSystemAction)(db, currentUser, 'UPDATE_AVATAR', '更新用戶頭像: ' + id);
