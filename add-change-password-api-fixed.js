...
// 在 //# sourceMappingURL 之前插入新路由
const sourceMapPattern = /\/\/# sourceMappingURL=users\.js\.map/;
...
if (content.match(sourceMapPattern)) {
  content = content.replace(sourceMapPattern, changePasswordRoute);
  fs.writeFileSync(filePath, content, 'utf8');
  console.log('SUCCESS: Change password API added');
} else {
  console.log('ERROR: Could not find sourceMappingURL pattern');
  process.exit(1);
}
