...
interface AdminShopCategoryManagementProps {
    categories: Category[];
...
export const AdminShopCategoryManagement: React.FC<AdminShopCategoryManagementProps> = ({ categories, onSaveCategory }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-4">商城商品分類管理</h2>
            <p className="text-sm text-gray-600 mb-4">管理商城商品的分類，與一番賞分類獨立</p>
