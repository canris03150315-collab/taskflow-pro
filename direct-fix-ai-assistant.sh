...
cp /app/dist/routes/ai-assistant.js /app/dist/routes/ai-assistant.js.backup

# Create new version with expanded context
cat > /app/dist/routes/ai-assistant-new.js << 'ENDOFFILE'
...
# Replace the file
mv /app/dist/routes/ai-assistant-new.js /app/dist/routes/ai-assistant.js

echo "SUCCESS: AI assistant file replaced with expanded version"
