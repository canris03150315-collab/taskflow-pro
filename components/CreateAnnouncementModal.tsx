        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                {images.map((img, index) => (
                  <div key={index} className="relative group">
                    ...
                    <button
                      ...
                      className="absolute top-1 right-1 bg-red-500 text-white rounded-full p-1 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 sm:focus-visible:opacity-100 transition"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
          ...
          <div className="flex justify-end pt-4">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 mr-2 text-slate-500 hover:bg-slate-100 rounded-lg font-bold transition"
            >
              取消
            </button>
            <button
