                  ...
                  <tbody className="bg-white divide-y divide-slate-200">
                    {stats.map((stat, idx) => (
                      <tr key={idx} className="hover:bg-stone-50">
                        ...
                        <td className="px-4 py-4 whitespace-nowrap text-right">
                          {(stat.total_lottery_dividend_receive || 0).toLocaleString()}
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap text-right">
                          {(stat.total_lottery_dividend_send || 0).toLocaleString()}
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap text-right">
                          {(stat.total_external_dividend_receive || 0).toLocaleString()}
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap text-right">
                          {(stat.total_external_dividend_send || 0).toLocaleString()}
                        </td>
                      </tr>
                    ))}
                  </tbody>
